...
describe('nutritional_supports table', function() {
	...
	it('URL： ' + data().url+'/customized/nutritional_supports?diseased_state_id=1&stage_id=6001&page=1&per_page=20', function(done) {  //非登陆状态下获取营养支持列表
	...
	it('URL： ' + data().url+'/customized/nutritional_supports?userkey=dd9d086254a94e3abb5bd14eb993441d&page=1&per_page=20', function(done) {  // 用户登陆状态下获取营养支持列表
